...
public class ExampleSet {
	...
	public void addTrainingExample(TrainingExampleModel example){
		if(this.trainingExamples==null){
			trainingExamples=new ArrayList<TrainingExampleModel>();
		}
		trainingExamples.add(example);
	...
	ExampleSet cloneForBagging(){
		ExampleSet cloneExampleSet = new ExampleSet();
		cloneExampleSet.NoOfAttributesInExample=this.NoOfAttributesInExample;
		cloneExampleSet.uniqueValuesInEachAttr= this.uniqueValuesInEachAttr;
		return cloneExampleSet;
	}
